...
Previously binary classification was used, e.g. target as max_phase 4 ("1") and used max_phase of "null" as "0" in my previous posts. This time I'll be using multi-class classification to predict max_phase which contains 0, 1, 2, 3, 4.
...
A full list of XGBoost classifier pipeline parameters can also be retrieved as shown below, which can be further tuned as desired.
