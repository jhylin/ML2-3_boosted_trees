...
The next step is to pickle the model or pipeline if wanting to save it for future use and to avoid re-training model again.
...
```{python}
# Pickle save (serialise) the model in working directory (specify path by changing code if needed)
