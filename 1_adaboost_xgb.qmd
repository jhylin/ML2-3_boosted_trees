...
**30/5/24: Change of plan - build a separate XGBoost classifier pipeline since planning to do a CV to look for optimal parameters. Demo at least showed an AdaBoost classifier model that will work by using either Morgan fingerprints and RDKit 2D descriptors on this tiny dataset of mols**
...
7. Hyperparameter tuning for XGBoost classifier
