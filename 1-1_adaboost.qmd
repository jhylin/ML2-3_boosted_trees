...
According to Scikit-learn, this is a histogram-based gradient boosting classification tree that is mainly inpired by [LightGBM](https://github.com/Microsoft/LightGBM), which I'm also attempting to use this time. *Mention key features in LightGBM and HistGradientBoostingClassifier*
...
mlpipe = make_pipeline(
    ...
    # Potentially adding HistGradientBoostingClassifier() next
