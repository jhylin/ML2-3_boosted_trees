...
table = [
    ["trains weak learners that are usually deeper with a max depth of 3 to 6 (or max number of 8 to 64 leaf nods)","trains weak learners (decision tree stumps based on errors from previous decision tree stump)"], 
