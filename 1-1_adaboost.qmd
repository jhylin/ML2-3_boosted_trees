...
A sample demo using scikit_learn's AdaBoostClassifier, GradientBoostingClassifer() & scikit_mol's transformers
...
# Set parameters for histgradboosting model
param_histgradboost = {}
...
mlpipe = make_pipeline(
    ...
    # Potentially adding HistGradientBoostingClassifier() or rather GradientBoostingClassifier() next
