...
Since the latest version of ChEMBL is currently sitting at 34, and rather than repeating what I did before, what I did was to use the previously cached ChEMBL data from version 33. To see the more reproducible way to retrieve ChEMBL data, please see this post - https://jhylin.github.io/Data_in_life_blog/posts/17_ML2-2_Random_forest/2_random_forest_classifier.html#data-retrieval-using-chembl_downloader 
...
# alternative way to download latest version
# note: need to specify late_version = latest() first
# please see post link provided above for details
