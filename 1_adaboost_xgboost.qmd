...
- A sample demo using AdaBoost classifier in scikit_learn, xgboost classifier & transformers from scikit_mol
...
# SAMME (Stagewise Additive Modeling using a Multi-class Exponential loss function) for multi-class classification
param_adaboost = {max_depth = 3, algorithm = "SAMME", random_state = 2}
