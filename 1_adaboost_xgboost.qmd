...
7. Hyperparameter tuning (*?shift to above prior to fitting model and building pipeline*)
    ...
    XGBoost contains a long list of parameters and one of the ways to find the most optimal set of parameters is using cross-validation.
...
Ideally, AdaBoost is not as useful as XGBoost (as mentioned in [@mlbook2022]) in real-life use cases. 
