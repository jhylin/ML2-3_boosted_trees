...
**SOLVED (checked & changed dtypes for X, y) - Check X, y variable sample numbers**
...
**So far fitting the data onto AdaBoostClassifier() worked above**

**Check if this pipeline has "predict" property?**
